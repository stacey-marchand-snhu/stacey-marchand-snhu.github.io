...
## Table of Contents
- [About Me](#about-me)
- [Key Skills: Five Core Professional Competencies](#key-skills-five-core-professional-competencies)
...
**Course Outcome:** <span class="gold">Employ strategies for building collaborative environments that enable diverse audiences to support organizational decision-making</span>
...
**Course Outcome:** <span class="gold">Design and evaluate computing solutions that solve a given problem using algorithmic principles and computer science practices and standards appropriate to its solution, while managing the trade-offs involved in design choices</span>

Early in my career, I relied on pattern recognition and practical experience to solve problems. The formal study of algorithms and data structures through this program has given me a vocabulary, a toolbox, and a rigorous framework for thinking algorithmically. In CS-360, I implemented linear regression on stock history to provide predictive analytics, a practical application of mathematical principles to a real business problem. In CS-465, I evaluated trade-offs between different architectural patterns, deciding when to use React over Angular, when to use Firestore instead of MongoDB, and how to balance complexity with maintainability. In my ML coursework, I designed neural networks for classification tasks.

Each project reinforced that the best solution isn't always the most complex one; it's the one that balances correctness, efficiency, maintainability, and the actual problem constraints. Artifact Two is the primary demonstration of this competency, where I designed time-series data structures, implemented and tested a linear regression algorithm with thoughtful edge-case handling, and evaluated trade-offs about when to show projections and when to avoid them.

### Software Engineering & Computing Practices
